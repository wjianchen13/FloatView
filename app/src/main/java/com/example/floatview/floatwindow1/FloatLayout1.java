 ...
 */
public class FloatLayout1 extends FrameLayout implements ScaleGestureDetector.OnScaleGestureListener{
    ...
    public FloatLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
