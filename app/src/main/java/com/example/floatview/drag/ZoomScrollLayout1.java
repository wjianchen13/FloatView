 ...
 * 可缩放Layout
 */
public class ZoomScrollLayout1 extends RelativeLayout implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public ZoomScrollLayout1(Context context) {
        super(context);
        init(context);
    }

    public ZoomScrollLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ZoomScrollLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
